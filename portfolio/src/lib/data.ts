...
export const projects: Project[] = [
  {
    ...
    tech: ['Next.js 15', 'React 19', 'Material-UI v6', 'Framer Motion', 'MongoDB', 'JWT', 'React Hook Form', 'React-PDF', 'QRCode', 'Flap Payment Gateway', 'TSD XML API'],
  ...
  },
  {
    ...
    tech: ['Node.js', 'Express', 'MSSQL', 'Focaltec REST API', 'Gmail OAuth2', 'log4js', 'Winston', 'PM2', 'Windows Server'],
  ...
  },
  {
    ...
    tech: ['Next.js', 'Node.js', 'Odoo API', 'Google Sheets API', 'Puppeteer'],
