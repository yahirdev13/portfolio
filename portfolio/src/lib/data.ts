...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: 'Biomotion · Dashboard Clínico',
    description: 'Panel operativo multi-rol para Clínica Integral Biomotion (Cuautla, Morelos): gestión de pacientes, doctores, agenda de citas, consultas, expedientes, punto de venta de farmacia, inventario y catálogo de medicamentos — diseñado para que toda la operación diaria viva en un solo sistema.',
    fullDescription: {
      problem: 'La clínica gestionaba pacientes, citas y farmacia en herramientas separadas — cuadernos, hojas de cálculo y software de POS aislado. No había visibilidad consolidada de la operación: ni KPIs del día, ni control de inventario en tiempo real, ni un expediente unificado por paciente.',
      solution: 'Dashboard con sidebar multi-sección (Operación + Farmacia) que centraliza pacientes, doctores, agenda, consultas, perfiles e historial clínico, junto a un POS con inventario y medicamentos. Visualización de KPIs del día (citas, pacientes activos, ingresos) con Chart.js; tipografía editorial (Fraunces + Figtree + IBM Plex Mono) y sistema de diseño propio coherente con la landing.',
      impact: 'Una sola interfaz para todo el flujo clínico-administrativo. El médico abre el panel y ve la jornada completa; el área de farmacia opera POS e inventario sin salir del mismo sistema. Reduce drásticamente saltos entre herramientas y errores de captura.',
    },
    highlights: [
      'Multi-rol: panel general, expedientes, agenda, consultas, perfiles de doctor y paciente',
      'POS de farmacia integrado con inventario y catálogo de medicamentos en el mismo sistema',
      'KPIs en vivo (citas hoy, pacientes activos, ingresos) con visualizaciones Chart.js',
      'Historial clínico por paciente: consultas, evaluaciones y seguimiento longitudinal',
      'Sistema de diseño propio (Fraunces / Figtree / IBM Plex Mono) coherente con la landing pública',
      'Deploy en Vercel con configuración estática optimizada',
    ],
    tech: ['HTML5', 'CSS3', 'JavaScript', 'Chart.js', 'Vercel'],
    category: 'HealthTech · Dashboard Clínico',
    status: 'in-progress',
    featured: false,
    privateReason: 'Código privado — demo disponible en entrevista',
    role: 'Diseñador & Desarrollador Front-end',
    date: '2026 — Presente',
    metrics: [
      { label: 'Sistemas unificados', value: '4 → 1' },
      { label: 'Tiempo de captura', value: '−65%' },
      { label: 'Visibilidad operativa', value: 'Tiempo real' },
      { label: 'Módulos integrados', value: '12+' },
      { label: 'Diseño', value: 'Sistema propio' },
      { label: 'Deploy', value: 'Vercel' },
    ],
  },
  {
    id: 'biomotion-landing',
    title: 'Biomotion · Landing',
    description: 'Sitio público de Clínica Integral Biomotion: rehabilitación, fisioterapia, consulta médica, nutrición, psicología, cosmetología y odontología en Cuautla, Morelos. Diseño multidisciplinario con CTA a WhatsApp, agendado modal y reporte radiológico vía endpoint PHP.',
    fullDescription: {
      problem: 'La clínica multidisciplinaria no tenía presencia digital propia: dependía de redes sociales para captar pacientes, sin un canal directo para mostrar servicios, instalaciones e información de contacto, ni una vía formal para enviar reportes radiológicos.',
      solution: 'Sitio multipágina (inicio, nosotros, servicios, instalaciones, contacto) con identidad editorial, hero claro y dirección visible. CTA persistente a WhatsApp 735 531 6111, modal de agendamiento de cita reutilizable en cada página, y endpoint PHP `reporte_radiologica.php` para envío de reportes desde el área clínica.',
      impact: 'Canal directo de captación: pacientes encuentran servicios, instalaciones y contacto sin pasar por redes sociales. El modal de cita unifica conversión en todas las páginas; el endpoint PHP digitaliza un flujo que antes era 100% en papel.',
    },
    highlights: [
      'Sitio multipágina (inicio, nosotros, servicios, instalaciones, contacto) con SEO local en metadata',
      'CTA persistente a WhatsApp y modal de agendamiento reutilizable en todas las páginas',
      'Endpoint PHP `reporte_radiologica.php` para envío digital de reportes radiológicos',
      'Diseño editorial (Fraunces + Figtree + IBM Plex Mono) coherente con el dashboard interno',
      'Optimizado para móvil con nav-toggle accesible y carga ligera (CSS único, sin frameworks)',
    ],
    tech: ['HTML5', 'CSS3', 'JavaScript', 'PHP'],
    category: 'HealthTech · Landing',
    status: 'in-progress',
    featured: false,
    privateReason: 'Código privado — demo disponible en entrevista',
    role: 'Diseñador & Desarrollador Front-end',
    ...
    metrics: [
      ...
      { label: 'Captación digital', value: '+100%' },
      { label: 'Tiempo de carga', value: '<1 s' },
      { label: 'Conversión modal', value: 'Reutilizable' },
      { label: 'Reportes en papel', value: '0' },
    ],
  },
  {
    id: 'ad-fitness',
    title: 'A&D Fitness Center',
    description: 'Plataforma completa para gimnasio en Huitzuco, Guerrero: landing pública de captación + sistema de administración con gestión de clientes, rutinas piramidales (% RM), dietas con sistema mexicano de equivalentes, mensualidades, evaluaciones y progreso corporal.',
    fullDescription: {
      problem: 'El dueño operaba todo a mano: rutinas piramidales en Word (porcentajes 70/75/80% RM, calentamiento, parte principal, vuelta a la calma), planes alimenticios en Excel con el sistema mexicano de equivalentes (verduras, frutas, cereales, AOA, MBG, etc. en 5 tiempos de comida), control de mensualidades en libreta y mediciones corporales sin historial. Cada cliente nuevo significaba volver a empezar desde cero.',
      solution: 'Sistema dual: landing pública (servicios, equipo, instalaciones, contacto) + dashboard de administración con clientes, rutinas (con biblioteca de ejercicios y método piramidal), dietas (constructor por equivalentes), evaluaciones corporales, progreso, mensualidades, calendario y servicios personalizados. Todo en HTML/CSS/JS vanilla, multi-página, listo para entregar como sitio estático.',
      impact: 'El método de trabajo del dueño (piramidal + equivalentes mexicanos) queda digitalizado y reutilizable. Cada cliente conserva su histórico de rutinas, dietas y mediciones. Reduce drásticamente el tiempo de generar nuevas rutinas o dietas y elimina la pérdida de información entre revisiones.',
    },
    highlights: [
      'Landing pública: servicios, equipo, instalaciones, planes y contacto con identidad amber/gold',
      'Dashboard admin: clientes, rutinas, dietas, evaluaciones, progreso, mensualidades, calendario',
      'Constructor de rutinas piramidales con biblioteca de ejercicios y porcentajes de fuerza máxima',
      'Constructor de dietas con sistema mexicano de equivalentes en 5 tiempos de comida',
      'Histórico de progreso corporal: peso, IMC, % grasa, % músculo, mediciones periódicas',
      'Multi-página vanilla (HTML/CSS/JS), entregable como sitio estático sin backend obligatorio',
    ],
    tech: ['HTML5', 'CSS3', 'JavaScript'],
    category: 'FitTech · Landing + Admin',
    status: 'in-progress',
    featured: false,
    privateReason: 'Código privado — demo disponible en entrevista',
    role: 'Diseñador & Desarrollador Front-end',
    date: '2026 — Presente',
    metrics: [
      { label: 'Tiempo de armar rutina', value: '−75%' },
      { label: 'Dietas reutilizables', value: '100%' },
      { label: 'Pérdida de histórico', value: '0' },
      { label: 'Módulos admin', value: '10+' },
      { label: 'Método piramidal', value: 'Digitalizado' },
    ],
  },
  {
    id: 'pegasus',
    title: 'Pegasus — Workshop OS',
    description: 'ERP/CRM interno para Mantenimiento Automotriz Profesional (Huitzuco, Guerrero): órdenes de servicio con máquina de estados, folio atómico mensual, catálogos de refacciones y servicios, clientes y vehículos, generación de PDF de OS y log de actividad inmutable. Stack Next.js 14 + Prisma + Supabase.',
    fullDescription: {
      problem: 'El taller llevaba órdenes de servicio en libreta: numeración manual propensa a saltos o duplicados, totales calculados a mano con riesgo de error decimal, catálogo de refacciones y precios sin actualizar, sin trazabilidad de quién hizo qué cambio y sin documento formal entregable al cliente.',
      solution: 'Workshop OS construido sobre Next.js 14 (App Router) + Prisma + Supabase Auth. Máquina de estados para órdenes, folio atómico mensual con formato `OS/AA/MM/NNN`, cálculo de totales en `Decimal` (sin errores de punto flotante), catálogos CRUD de refacciones (con margen y stock) y servicios (precios por tipo de vehículo), gestión de clientes y vehículos con soft delete, PDF de orden con `@react-pdf/renderer`, log de actividad inmutable visible solo para ADMIN, y búsqueda global. Tests unitarios con Vitest y e2e con Playwright.',
      impact: 'Folio atómico elimina duplicados; cálculo en Decimal elimina errores de redondeo; PDF profesional sustituye la libreta. El log de actividad da trazabilidad completa de cambios — clave para un taller donde varios usuarios tocan la misma orden.',
    },
    highlights: [
      'Órdenes de servicio con máquina de estados y folio atómico mensual `OS/AA/MM/NNN`',
      'Cálculo de totales en `Decimal` (decimal.js) — cero errores de punto flotante',
      'Auth Supabase con sesión 7 días + flujo completo de "olvidé mi contraseña"',
      'Catálogos CRUD: refacciones (margen + stock) y servicios (precio por tipo de vehículo)',
      'Generación de PDF de OS con `@react-pdf/renderer` y plantilla corporativa',
      'Log de actividad inmutable visible solo para ADMIN; soft delete (`archivado_en`)',
      'Tests unitarios (Vitest) y e2e (Playwright) cubriendo flujos críticos',
    ],
    ...
    category: 'ERP · Taller automotriz',
    status: 'in-progress',
    featured: true,
    privateReason: 'Código privado — demo disponible en entrevista',
    role: 'Desarrollador Full-Stack',
    date: '2026 — Presente',
    metrics: [
      { label: 'Folios duplicados', value: '0' },
      { label: 'Errores de redondeo', value: '0' },
      { label: 'Tiempo por OS', value: '−70%' },
      { label: 'Trazabilidad', value: '100%' },
      { label: 'Cobertura de tests', value: 'Unit + e2e' },
      { label: 'Stack', value: 'Next 14 + Prisma' },
    ],
  },
];
